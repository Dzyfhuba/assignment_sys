 ...
 * @author ubaid
 */
public class RegisterPage extends JFrame implements Verify {
    ...
    RegisterPage() {
        ...
        bg_opt.add(opt_sender);
        bg_opt.add(opt_receiver);
        content_pane.add(opt_sender);
        content_pane.add(opt_receiver);
        ...
        btn_submit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                role = opt_sender.isSelected() ? "sender" : "receiver";
